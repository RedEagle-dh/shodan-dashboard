    ...
    async execute(event) {
        const mainHelpEb = new EmbedBuilder().setTitle("Help? - Here you go!").setColor("#2F3136")
            .setDescription("Just select a section below to get more information about the commands and their usage.\n\n" +
                ...
                "<:rolemod:1021588461821636718>  Only members with the permission `ManageMessages` can use this\n" +
                "<:nitro:1030956008102711326> Only nitro booster can use this command\n" +
                "<:roleicon:1021588428703420426> Every member can use this command\n " +
                "<:botdev:1030956009805582388> Only the bot developers can use this command\n\n")
